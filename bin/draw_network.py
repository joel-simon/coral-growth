...
in_names = ['Light', 'Curvature', 'Gravity', 'Chemical 1U', 'Chemical 2U', 'memory-in 1', 'memory-in 2',  'Bias']
out_names = ['Growth', 'Chemical 1V', 'Chemical 2V', 'memory-out 1', 'memory-out 2']
